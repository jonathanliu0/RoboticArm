...
STATES = [State(name='IDLE', id=0, devices={'master': DeviceState(values={}, events=[]), 'tablet': DeviceState(values={}, events=[])}), State(name='OFF', id=1, devices={'master': DeviceState(values={}, events=[]), 'tablet': DeviceState(values={}, events=[])}), State(name='ROBOTICARM', id=2, devices={'master': DeviceState(values=OrderedDict(), events=['moveToHigh', 'moveToLow', 'magnetOn', 'magnetOff', 'armUp', 'armDown', 'goHome']), 'tablet': DeviceState(values={}, events=[])})]
